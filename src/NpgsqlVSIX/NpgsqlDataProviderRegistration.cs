    ...
    class NpgsqlDataProviderRegistration : RegistrationAttribute
    {
        public override void Register(RegistrationAttribute.RegistrationContext context)
        {
            ...
            try
            {
                ...
                providerKey.SetValue("Description", $"Provider_Description, {GetType().Namespace}.Resources, NpgsqlVSIX");
                providerKey.SetValue("DisplayName", $"Provider_DisplayName, {GetType().Namespace}.Resources, NpgsqlVSIX");
                ...
                providerKey.SetValue("ShortDisplayName", $"Provider_ShortDisplayName, {GetType().Namespace}.Resources, NpgsqlVSIX");
